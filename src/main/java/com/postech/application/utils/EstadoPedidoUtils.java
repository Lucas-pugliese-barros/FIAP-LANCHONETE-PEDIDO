...
public class EstadoPedidoUtils {
    ...
    public static boolean validaEstado(EstadoPedidoEnum estadoAtual, EstadoPedidoEnum novoEstado) {
        return switch (estadoAtual) {
            case RECEBIDO -> novoEstado == EstadoPedidoEnum.PAGO || novoEstado == EstadoPedidoEnum.CANCELADO;
            case PAGO -> novoEstado == EstadoPedidoEnum.PREPARANDO || novoEstado == EstadoPedidoEnum.CANCELADO;
